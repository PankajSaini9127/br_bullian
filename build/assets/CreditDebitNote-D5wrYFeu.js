import{r as l,B as t}from"./vendor-UKnYS2Ok.js";import{y as c}from"./toastify-CS0d0PNp.js";import{p as M}from"./partyService-P-vmZ_y-.js";import{a as U}from"./axios-DcNlVx-A.js";import{a as J,g as i}from"./index-C79XlsqY.js";import{a as K,B as b,b as P,ad as g,h as f,aC as Q,aD as X,$ as Y,a0 as Z,P as V,a1 as ee,a2 as te,a3 as D,a4 as o,a5 as ae,f as k,a7 as re,aj as se,a8 as ne,aa as oe,ab as ie,ac as de,ak as le,e as m,ae as ce,aA as he}from"./mui-BWoEF6q2.js";import"./pdf-Crbg--cW.js";const pe="http://localhost:8080/api",p=U.create({baseURL:pe});p.interceptors.request.use(r=>{const h=localStorage.getItem("token");return h&&(r.headers.Authorization=`Bearer ${h}`),r.headers["Content-Type"]="application/json",r},r=>Promise.reject(r));J(p);const N={createNote:r=>p.post("/notes",r),getNotes:(r={})=>p.get("/notes",{params:r}),getNoteById:r=>p.get(`/notes/${r}`),updateNote:(r,h)=>p.put(`/notes/${r}`,h),deleteNote:r=>p.delete(`/notes/${r}`)},be=()=>{const[r,h]=l.useState("credit"),[T,w]=l.useState([]),[$,v]=l.useState(!1),[x,I]=l.useState(null),[F,L]=l.useState([]),[_,y]=l.useState(!1),[A,W]=l.useState(!1),[n,u]=l.useState({partyName:"",partyId:"",noteDate:new Date().toISOString().split("T")[0],amount:"",fine:"",reason:""});l.useEffect(()=>{B()},[]),l.useEffect(()=>{S()},[r]);const B=async()=>{try{y(!0);const e=await M.getParties(),a=(e==null?void 0:e.data)||e;L((a==null?void 0:a.parties)||[])}catch(e){console.error("Error fetching parties:",e),c.error("Failed to fetch parties")}finally{y(!1)}},S=async()=>{var e;try{y(!0);const a=await N.getNotes({noteType:r}),s=(a==null?void 0:a.data)||a,d=((e=s==null?void 0:s.data)==null?void 0:e.notes)||(s==null?void 0:s.notes)||(s==null?void 0:s.data)||s;w(Array.isArray(d)?d:[])}catch(a){console.error("Error fetching notes:",a),c.error("Failed to fetch notes"),w([])}finally{y(!1)}},j=e=>{const{name:a,value:s}=e.target;u({...n,[a]:s})},O=()=>{v(!0),I(null),u({partyName:"",partyId:"",noteDate:new Date().toISOString().split("T")[0],amount:"",fine:"",reason:""})},R=e=>{I(e);const a=e.partyId||e.party;u({partyName:(a==null?void 0:a.partyName)||e.partyName||"",partyId:(a==null?void 0:a._id)||e.partyId||"",noteDate:e.date?e.date.split("T")[0]:e.noteDate||new Date().toISOString().split("T")[0],amount:e.amount!==void 0?String(e.amount):"",fine:e.fine!==void 0?String(e.fine):"",reason:e.reason||""}),v(!0)},H=(e,a)=>{u({...n,partyName:(a==null?void 0:a.partyName)||"",partyId:(a==null?void 0:a._id)||""})},C=()=>{v(!1),I(null),u({partyName:"",partyId:"",noteDate:new Date().toISOString().split("T")[0],amount:"",fine:"",reason:""})},q=async()=>{var a,s;if(!n.partyId){c.error("Please select a party");return}if(!n.amount&&!n.fine){c.error("Please fill either Amount or Fine");return}const e={noteType:r,date:n.noteDate,partyId:n.partyId,reason:n.reason,amount:n.amount?parseFloat(n.amount):0,fine:n.fine?parseFloat(n.fine):0};try{W(!0),x?(await N.updateNote(x._id||x.id,e),c.success("Note updated successfully")):(await N.createNote(e),c.success("Note added successfully")),C(),S()}catch(d){console.error("Error saving note:",d),c.error(((s=(a=d==null?void 0:d.response)==null?void 0:a.data)==null?void 0:s.message)||"Failed to save note")}finally{W(!1)}},z=async e=>{if(window.confirm("Are you sure you want to delete this note?"))try{await N.deleteNote(e),c.success("Note deleted successfully"),S()}catch(a){console.error("Error deleting note:",a),c.error("Failed to delete note")}},G=e=>{var s,d,E;const a=window.open("","_blank");a.document.write(`
      <html>
        <head>
