...
const Sauda = () => {
  ...
  useEffect(() => {
    fetchSaudaList();
  }, [tabValue, searchPartyId, filterStartDate, filterEndDate]);
          ...
          >
            ...
            <Grid container spacing={2} sx={{ mb: 2 }}>
              <Grid item xs={12} md={4}>
                <Autocomplete
                  ...
                  onChange={(e, newValue) => setSearchPartyId(newValue?._id || '')}
            ...
            <TableContainer>
              <Table>
                ...
                <TableBody>
                  {getFilteredSaudaList().map((sauda, index) => (
                    <TableRow
                      key={sauda.id}
                      sx={{
                        '&:hover': {
